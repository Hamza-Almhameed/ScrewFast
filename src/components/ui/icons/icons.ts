export const Icons = {
  groups: {
    ...
    class: "mt-1 h-8 w-8 flex-shrink-0 fill-newTheme-100 dark:fill-newTheme-200",
    width: 48,
    height: 48,
  ...
  tools: {
    ...
    class:
      "mt-2 h-6 w-6 flex-shrink-0 fill-neutral-700 hs-tab-active:fill-newTheme-100 dark:fill-neutral-300 dark:hs-tab-active:fill-newTheme-200 md:h-7 md:w-7",
    width: 48,
    height: 48,
    viewBox: "0 -960 960 960",
  },
  ...
  house: {
    ...
    class:
      "h-6 w-6 flex-shrink-0 text-neutral-700 hs-tab-active:text-newTheme-100 dark:text-neutral-300 dark:hs-tab-active:text-newTheme-200 md:h-7 md:w-7",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  arrowUp: {
    ...
    class: "h-5 w-5 flex-shrink-0 text-newTheme-100 dark:text-newTheme-200",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "none",
  ...
  github: {
    ...
    class:
      "w-4.5 h-4.5 transition flex-shrink-0 duration-300 group-hover:-translate-y-1",
    width: 16,
    height: 16,
    viewBox: "0 0 16 16",
    fill: "currentColor",
